...
% 报告标题（页眉使用，修改只需改这一处）
\newcommand{\reporttitle}{数据挖掘实验报告}
\usepackage[margin=1in,headheight=15pt]{geometry} % to change the page dimensions
\usepackage{ctex}
\usepackage{xeCJK}
\usepackage{amsmath}
\usepackage{amssymb}
...
%\usepackage{cite}
%\usepackage{courier}
% 等宽字体：优先 Courier New（Windows），否则回退到 DejaVu Sans Mono（Linux/macOS）
...
\newtheorem{example}{例}
\usepackage{amsfonts}
\usepackage{array} % \extrarowheight（封面表格行高）
%\usepackage{bm}
...
\pagestyle{fancy}
\lhead{\kaishu~\reporttitle~}
%\rhead{\kaishu~xxx}
\cfoot{\thepage}
\titleformat{\chapter}{\centering\zihao{2}\heiti}{}{0em}{}
...
\begin{titlepage}
    ...
    \includegraphics[width=0.60\textwidth]{figures/nk_logo.pdf}\\
    \vspace{10mm}
    \hspace*{\fill} \\
...
\end{itemize}
\section{实验结果与分析}
\par 通过两种方法下生成的特征图可以看出，两类图有明显不同的纹理特征。图~\ref{1.1}\ 与图~\ref{1.2}\ 为灰度共生矩阵下的图例；图~\ref{1.3}\ 与图~\ref{1.4}\ 为局部二值模式下的图例。全部图片请见\href{https://github.com/psa1K/Data_mining_2024/tree/main/demos/figures}{特征图}。
\begin{figure}[htbp]
    \centering
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp1_glcm_cloud.png}
        \caption{云的灰度共生矩阵图}
        \label{1.1}
    \end{minipage}
    \hfill
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp1_glcm_forest.png}
        \caption{森林的灰度共生矩阵图}
        \label{1.2}
    \end{minipage}
\end{figure}
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp1_lbp_cloud.png}
        \caption{云的局部二值模式图}
        \label{1.3}
    \end{minipage}
    \hfill
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp1_lbp_forest.png}
        \caption{森林的局部二值模式图}
        \label{1.4}
    \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp2_train.png}
        \caption{训练集与决策面}
        \label{2.1}
    \end{minipage}
    \hfill
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp2_test.png}
        \caption{测试集与决策面}
        \label{2.2}
    \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/exp3_accuracy.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp4_accuracy_depth.png}
    ...
    \begin{minipage}{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/exp4_decision_tree.png}
...
\begin{figure}[hbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/exp5_auc.png}
